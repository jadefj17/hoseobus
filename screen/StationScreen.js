        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.daySelector}>
                <TouchableOpacity
                    style={[
                        styles.dayTab,
                        selectedDay === 'weekday' && styles.dayTabActive,
                    ]}
                ...
                <TouchableOpacity
                    style={[
                        styles.dayTab,
                        selectedDay === 'saturday' && styles.dayTabActive,
                    ]}
                ...
                <TouchableOpacity
                    style={[
                        styles.dayTab,
                        selectedDay === 'holiday' && styles.dayTabActive,
                    ]}
                ...
                <View style={styles.checkboxContainer}>
                    <TouchableOpacity
                        ...
                        onPress={() => toggleCheckbox('shuttle')}
                    >
                        <View
                            style={[
                                styles.checkboxBox,
                                checkboxes.shuttle && styles.checkboxChecked,
                            ]}
                        >
                    ...
                    <TouchableOpacity
                        style={styles.checkbox}
                        onPress={() => toggleCheckbox('bus')}
                    >
                        <View
                            style={[
                                styles.checkboxBox,
                                checkboxes.bus && styles.checkboxChecked,
                            ]}
                        >
            ...
            <ScrollView
                style={[styles.timeTableContainer, { height: screenHeight * 0.6 }]}
            >
                {timeTableData.map(item => (
                    <View key={item.time} style={styles.timeRow}>
                        <Text style={styles.timeText}>{item.time}</Text>

                        {checkboxes.shuttle && item.shuttle && (
                        ...
                        {checkboxes.bus &&
                            item.buses.map(bus => (
                                <View key={bus} style={styles.busButton}>
